            ...
            <Card>
              ...
              <Card.Body>
                <div className="ct-chart" id="chartActivity">
                  <ChartistGraph
                    data={{
                      labels: loadedMeasurements.map((measurement) => {
                        const days = ['Zondag', 'Maandag', 'Dinsdag', 'Woensdag', 'Donderdag', 'Vrijdag', 'Zaterdag'];
                        const date = new Date(measurement.logTimeStamp)
                        console.log(date.getDay())
                        return days[date.getDay()]
                      }),
                      series: [
                          loadedMeasurements.map((measurement) => measurement.electricityProduced ? measurement.electricityProduced * 100 : 0),
                          loadedMeasurements.map((measurement) => measurement.electricityConsumed ? measurement.electricityConsumed * 100 : 0),
                          loadedMeasurements.map((measurement) => measurement.gasConsumed ? measurement.gasConsumed * 100 : 0)
                      ],
                    }}
                    type="Bar"
                    options={{
              ...
              <Card.Footer>
                <div className="legend">
                  <i className="fas fa-circle text-danger"></i> Energie Verbruik
                  <i className="fas fa-circle text-info"></i> Energie Teruggave
