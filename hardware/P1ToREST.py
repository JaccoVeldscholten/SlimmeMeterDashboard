...
while True:
    print("Fetch some measurements ;)")
    try:
        ser.open()
    except:
        print("FOUT IN SERIAL CONNECTION!")
        time.sleep(10)
        continue        # Wait for 10 seconds.
    ...
    while not checksum_found:
       ...
       # print(telegram_line.decode().strip())
    ...
    try:
        ...
        print("No connection to API. Lets wait for while")
        time.sleep(10)
        continue


    time.sleep(300)                           # Slow down Fetching data
